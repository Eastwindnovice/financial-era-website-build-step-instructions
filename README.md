...
框架进行重构，技术栈就是Next.js、TypeScript、Tailwind CSS、Shadcn UI、Framer Motion。来重构这个html文件源码。至于关于右上角的那一个地球的那个红蓝渐变色，后续我们再做精细化的一个调整。还有对应的一个下面的几个模块的那一个图标，我们也先暂且使用 AI 给的这一个小图标来替代。